...
class ResPartner(models.Model):
    ...
    tax_withholding_isr = fields.Selection(
        ...
        ], string="Régimen SAT", default="quarter_witholding"
    )
    ...
    @api.onchange('tax_withholding_isr')
    def _onchange_tax_withholding_isr(self):
        if self.tax_withholding_isr:
            if self.tax_withholding_isr == "smallcompany_taxpayer":
