    ...
    def _lines(self, data, partner):
        ...
        for r in res:
            ...
            r['displayed_name'] = '-'.join(
                r[field_name] for field_name in ('move_name', 'ref', 'name', 'bankref')
