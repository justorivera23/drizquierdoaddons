...
class AccountAgedTrialBalance(models.TransientModel):
    ...
    period_length = fields.Integer(string='Tamaño de período (días)', required=True, default=30)
    journal_ids = fields.Many2many('account.journal', string='Diarios', required=True)
    date_from = fields.Date(default=lambda *a: time.strftime('%Y-%m-%d'), string="Fecha de inicio")
